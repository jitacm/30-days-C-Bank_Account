...
// Create account, requires PIN and accepts full name with spaces
void createAccount()
{
    struct Account a;
...
// Search account by number (full details if PIN correct)
void searchAccount()
{
    int acc_no, pin;
...
// Update Account Holder Name (accepts full name with spaces)
...
int main()
{
    ...
    do
    {
        ...
        printf(YELLOW "5. Search Account\n" RESET);
        printf(YELLOW "6. Update Account Holder Name\n" RESET);
        printf(YELLOW "7. Delete Account\n" RESET);
